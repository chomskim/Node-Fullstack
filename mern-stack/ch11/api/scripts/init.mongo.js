...
that appears when clicking on Add`,
  },
  {
    ...
    owner: 'Kim',
    effort: 99,
    created: new Date('2020-05-22'),
    title: 'Hello World',
    description: `You could run this script using the usual command to
initialize the database so that the description matches your tests
and the screenshots in this chapter`,
  },
];
