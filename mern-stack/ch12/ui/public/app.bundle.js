      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            console.log("window.ENV.UI_API_ENDPOINT =", window.ENV.UI_API_ENDPOINT);
